...
class SolicitacaoExame(models.Model):
    ...
    usuario = models.ForeignKey(User, on_delete=models.CASCADE, related_name='solicitacoes_exames_usuarios')
...
class PedidosExames(models.Model):
    usuario = models.ForeignKey(User, on_delete=models.CASCADE, related_name='pedidos_exames_usuarios')
